...
invoke(brick,'Xrange',num2str(Xrange(1) ,'%.4f'),num2str(Xrange(2) ,'%.4f'));
invoke(brick,'Yrange',num2str(Yrange(1) ,'%.4f'),num2str(Yrange(2) ,'%.4f'));
invoke(brick,'Zrange',num2str(Zrange(1) ,'%.4f'),num2str(Zrange(2) ,'%.4f'));
